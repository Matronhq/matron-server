...
//! MATRON_SERVER_VERSION_EXTRA env variables used if specified
//!
//! Set the environment variable `MATRON_SERVER_VERSION_EXTRA` to any UTF-8
//! string to include it in parenthesis after the SemVer version. A common
//! value are git commit hashes.

use std::sync::OnceLock;

static BRANDING: &str = "Matron Server";
static SEMANTIC: &str = env!("CARGO_PKG_VERSION");
matron_server_macros::git_commit! {}
matron_server_macros::git_semantic! {}
...
fn init_version() -> String {
	option_env!("MATRON_SERVER_VERSION_EXTRA")
		.or(option_env!("TUWUNEL_VERSION_EXTRA"))

...
/// Invite the user to the matron-server admin room.
///
...
pub async fn make_user_admin(&self, user_id: &UserId) -> Result {
	...
	if self.services.server.config.admin_room_notices {
		let welcome_message = String::from(
			"## Thank you for trying out Matron Server!\n\nMatron Server is a continuation of conduwuit which was technically a hard fork of Conduit.\n\nHelpful links:\n> GitHub Repo: https://github.com/matronhq/matron-server\n> Documentation: https://matronhq.github.io/matron-server\n> Report issues: https://github.com/matronhq/matron-server/issues\n\nFor a list of available commands, send the following message in this room: `!admin --help`",
		);

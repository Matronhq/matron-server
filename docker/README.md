...
> [!NOTE]
> This directory is for building docker images. For [deploying](https://github.com/matronhq/matron-server/tree/main/docs/deploying)
> [docker](https://github.com/matronhq/matron-server/blob/main/docs/deploying/docker.md) visit
...
cues from the primary user of this system, the [GitHub CI](https://github.com/matronhq/matron-server/blob/main/.github/workflows/main.yml#L32)
...
[GitHub CI](https://github.com/matronhq/matron-server/blob/7e8c4c8883ca17de91c3323d329541342366ee0c/.github/workflows/test.yml#L140).
